...
class Page(MPTTModel):
    ...
    title_en = models.CharField(_('title (EN)'), max_length=30, default="")
    ...
    teaser_en = models.CharField(_('teaser (EN)'), max_length=100, blank=True)
    text = MarkupField(_('text'), markup_type='markdown', escape_html=True)
    text_en = MarkupField(_('text (EN)'), markup_type='markdown', escape_html=True)
